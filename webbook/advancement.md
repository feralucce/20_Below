...
next_url: /webbook/running-the-game.html
next_title: "Running the Game"
---
<!-- Generated by tools/scriv2web.py from 12-advancement.md - the chapter as it is
...
<p class="block-title" markdown="span">Session XP - the five categories</p>

| Category | XP | What it is for |
|---|---|---|
| Attendance and Participation | 1 | Showed up and played. |
| Good Roleplaying | 1 | You played them well. |
| Heroism and Risk Faced | 1 | Took a real risk in character. |
| Learning and Discovery | 1 | You learned something significant about your character, the plot, or the world. |
| Standout Moment | 1 | The GM’s discretion - a beat somebody brings up again three sessions later. |
...
<p class="block-title" markdown="span">Boons - creation cost and what it costs later</p>
...
<p class="block-title" markdown="span">Gift Adders - creation cost and what it costs later</p>
...
<p class="block-title" markdown="span">Past ten - what accumulates</p>
