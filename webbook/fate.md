...
prev_title: "Flaws"
next_url: /webbook/equipment.html
next_title: "Weapons & Equipment"
---
<!-- Generated by tools/scriv2web.py from 10-fate.md - the chapter as it is
...
Fate is the part of the system that admits the dice aren’t the whole story.

Everything so far has been about what your character can do. This is about the thumb you get to put on the scale - where it comes from, and what it costs. Three things live here: your **Nature**, which is who your character fundamentally is and how they earn Fate Tokens; the **Tokens** themselves, and what you spend them on; and **Ki**, the pool that fuels everything supernatural you own.

Nature is the one people underestimate. It isn’t a personality label for the top of the sheet - it’s the trigger that pays you. Play to it and the system hands you resources. Play against it and you get nothing, which is its own answer about whether you picked the right one.

A parallel resource layered on top of the core roll - playing into vulnerability, flaws, and bad luck funds a currency spent later.
...
**One or two words** - a label, not a paragraph. If it doesn’t fit on the character sheet in a glance, it’s too long. **Write the Drive as one sentence** - what you want or how you engage the world, not a backstory fact. “I lost my brother” is backstory; “I don’t let anyone else lose someone they can save” is a Nature. **Make the trigger concrete and repeatable.** If you’d have to ask the GM whether it applies, it’s too vague - a Nature should come up scene after scene, not once at the table. It doesn’t need to cost you anything the way a Flaw does, but the best ones occasionally do - a Showman blowing their cover for a dramatic entrance is playing to Nature *and* creating a problem, and that’s when it’s most fun.
