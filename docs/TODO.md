...
- [ ] **New**: whether Freebie Points can be spent on all four categories or only some, and their conversion rate per category — assumed all four ([source redacted]-style) but not confirmed.
