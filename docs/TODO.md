...
- [ ] **How much XP is a character actually awarded** (per session, per milestone, GM discretion?) — the costs above are only ratios until this is set; researched [source redacted] pacing as a reference point (see the 2026-07-14 design-log entry) but haven't yet back-calculated an award rate from it.
