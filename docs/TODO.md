...
- [ ] Confirm the exact list of available Actions (adopt [source redacted]'s list as a baseline, or build our own?), and what triggers/uses are valid for the Reaction.
