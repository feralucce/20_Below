...
- [x] **Flaw list compiled** (resolved 2026-07-14): sourced from [source redacted] (numeric-penalty entries excluded, mirroring Perks' exclusion of numeric-bonus Feats). Categories: Physical, Mental/Cognitive, Social, Combat-Adjacent. See [flaws.md](../rules/flaws.md#flaw-list).
