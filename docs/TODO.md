...
- [x] Called Shot location-effects proposal drafted ([source redacted] hit-location-inspired): Head (Stunned, TBD), Arms/Hands (Disarmed/Impaired), Legs/Feet (Move reduced). Eyes removed as a location (2026-07-13). Not yet confirmed.
