...
- [x] Action economy baseline: [source redacted]-style Move / Action / Bonus Action / Reaction.
...
- [ ] Confirm the exact list of available Actions/Bonus Actions (adopt [source redacted]'s list as a baseline, or build our own?).
