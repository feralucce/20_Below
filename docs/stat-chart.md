...
Earth's Healing mechanic (back on Earth, still undefined), Weft's exact mechanic (Luck-focused, being researched, plus the Ki-refill candidate job), Presence/Psyche mechanics (proposed but not locked), Stamina's non-combat mechanic, what happens at 0 Health Levels, Health Level recovery, and the rest of the open-questions TODO list in [design-log.md](design-log.md#open-questions).
