...
| **Wyrd** | Fate/destiny/the supernatural | **Warp** | Derived stat: `Defense = 10 − Warp`. Defense becomes the attacker's Difficulty when targeting this character. | **Weft** | **Back to Luck-focused, 2026-07-22** — the Healing expansion was undone. Weft is being actively researched now as **Luck as an active force** (see design-log for sourcing). Also still carries the earlier candidate job of refilling Ki. |
...
Earth's Healing mechanic (back on Earth, still undefined), Weft's exact mechanic (Luck-focused, being researched, plus the Ki-refill candidate job), what a connecting Social/Mental die costs the defender, Stamina's non-combat mechanic, what happens at 0 Health Levels, Health Level recovery, and the rest of the open-questions TODO list in [design-log.md](design-log.md#open-questions).
