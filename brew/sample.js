...
export function guide() {
  return [
    ...
    '## Four markers',
    '',
    'The whole syntax is four things.',
    '',
    F,
    B + 'page',
    ...
    'you say so. The second numbers the pages and the third draws this',
    'file' + APOS + 's own backgrounds. The last opens a block, and the bare',
    'colons close it.',
    '',
    B + 'page',
    '',
