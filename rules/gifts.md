...
In addition to [source redacted] feats/spells, [source redacted], Trinity, and Aberrant (used for the resolution-mechanic research above), the following are earmarked for compiling an actual example Gift list later: **[source redacted]**, **[source redacted]** (whose power category is literally also called "Gifts"), **[source redacted]** (Spheres), **[source redacted]** ([source redacted]), and **[source redacted]** (Edges). No list has been compiled yet — deferred until requested.
