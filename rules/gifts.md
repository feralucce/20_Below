...
- **Cost to raise a Gift level during advancement (XP)** — flat per level, or a scaling cost curve ([source redacted]-style, where level 5 costs much more than level 1)? (Character-creation cost is resolved — see Resolved below.)
