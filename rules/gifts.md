...
See [premade-gifts.md](premade-gifts.md) for a complete catalog of **62 Gifts, every one with all 5 levels fully defined**, organized into 15 alphabetized categories. Ready to hand a player at the table as-is. (Cybernetics' sole entry, *Grafted Steel*, was removed 2026-07-15 — see [premade-gifts.md](premade-gifts.md#cybernetics--note). *Bulwark*, granting Soak, was added the same day — see [premade-gifts.md](premade-gifts.md#bulwark-damage-resistance--toughness). Catalog count dropped from 77 to 61 across two consolidation passes on 2026-07-16, then rose to 62 the same day with the addition of *Healer's Touch* (heal an ally by touch) during the monitored review pass — see [gift-review-progress.md](gift-review-progress.md) for the full log.)
