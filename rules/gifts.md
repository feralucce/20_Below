...
- Cost to acquire/raise a Gift level (points at creation, XP after) — flat per level, or a scaling cost curve ([source redacted]-style, where level 5 costs much more than level 1)?
