...
Compiled from [source redacted] — see [premade-gifts.md](premade-gifts.md) for the source cross-reference and three fully worked example Gifts (all 5 levels defined) demonstrating the format.
