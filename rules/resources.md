...
**Cost**: at character creation, each level costs a flat **2 points** from the same creation pool [Boons](boons.md) draw from — a Resource at Level 3 costs 6 points total. After creation, raising a Resource by one level costs a flat **3 XP** per step.
...
|---|---|---|---|
| 1 | A modest single room or hideout, minimal security | One reliable contact for small favors or info | Known within a small local circle |
| 2 | A proper base with basic amenities and working locks | A handful of contacts spanning a couple of fields | Recognized across a city or subculture |
...
| 5 | A near-impenetrable, fully self-sufficient stronghold | A vast network reaching into any relevant field or region, including genuinely powerful people | World-renowned, a household name |

| Level | Followers | Fringe Benefit | Notable Vehicle |
|---|---|---|---|
...
| Level | Wealth |
|---|---|
| 1 | Paycheck-to-paycheck; covers rent and food, nothing extra |
| 2 | Comfortable; can afford occasional splurges without strain |
| 3 | Well-off; owns property outright, can make major purchases freely |
