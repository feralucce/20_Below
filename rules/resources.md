...
|---|---|---|---|
| 1 | A dedicated, secure space of your own — a real hideout, workshop, or safehouse beyond an ordinary home; basic, but genuinely defensible | One reliable contact for small favors or info | Known within a small local circle |
...
| 2 | Genuinely well-off — real disposable income, enough saved to absorb an emergency without real strain |
