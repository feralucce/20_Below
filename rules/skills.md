...
Inspired by [[source redacted]'s step system]([source redacted]), but folded into the existing roll — instead of a separate flat skill number, a Skill's **training tier** changes *how* the [core roll](core-mechanic.md#resolution) is built:
