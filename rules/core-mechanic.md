...
**Open questions**:
- If a player still has an unspent Spark when the GM would otherwise award one, does the award do nothing, or can it be redirected to another player (mirroring [source redacted])?
