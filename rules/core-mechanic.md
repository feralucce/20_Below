...
**Locked in 2026-07-22**: Ki's combat sub-stat is named **Resistance**, but it doesn't appear on the character sheet directly for combat purposes — instead it feeds a separate, derived entry called **Defense**, the same way [source redacted] is a derived number rather than a raw stat.
...
**Changed 2026-07-22**: switched from a flat 1d20 to a **bell curve**, inspired by [source redacted]/Obstacle dice-pool approach.
...
**Rewritten 2026-07-22**, replacing the "2d20 take lower/higher" version to fit the new 2d10 base roll, adapting [source redacted]/Obstacle mechanic: **Advantage** rolls **3d10 and keeps the lowest two** (summed); **Disadvantage** rolls **3d10 and keeps the highest two** (summed) — roll-under, so lower is always better. Usable wherever a specific rule grants it — currently the [Expert/Master Skill Training Tiers](skills.md#training-tiers), but not restricted to that.
