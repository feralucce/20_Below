...
- **Automatic Success / Resist a Mind-Affecting Effect** — **flagged as a maybe.** Powers/supernatural abilities haven't been designed yet, and this spend may end up folded into that system instead of staying a generic Fate spend.
- **Boost a Check / Shrug Off an Effect** — **flagged for review.** May already be covered in spirit by the [Skill Training Tiers](skills.md#training-tiers) (Adept/Expert/Master already grant Advantage and widened crit ranges) — worth checking for redundancy before keeping this as a separate spend.
