...
Flaws are the mirror image of [Boons](boons.md) - disadvantages, quirks, or complications a player can choose for their character.

- **Every Flaw is Leveled, rated 1-5**, the same shape as [Resources](resources.md). There are no flat, non-Leveled Flaws.
...
| 2 | Level 1, plus: while triggered, cannot declare a Slow [Action Bracket](rules.md#action-brackets) - full aggression only, no called shots or concentration. |
...
| Level | Effect |
|---|---|
| 1 | A rough patch. [Creation-Wealth](resources.md#wealth-at-character-creation) is **0** instead of the default 2 for gear shopping at creation, and no Resources Pool or Discretionary points may be spent on Wealth while this Flaw is held - buy it off first - see [Starting Packages](weapons.md#starting-packages) for what's still available at Level 0. Doesn't follow you past creation; whatever put you here (a lost job, a bad breakup, a bad month) is already turning around. |
...
| Level | Effect |
|---|---|
| 1 | First round of combat, act last within your declared [Action Bracket](rules.md#action-brackets), regardless of Initiative. |
...
| 4 | Levels 1-3, plus: while in combat, they act at [Disadvantage](rules.md#advantage--disadvantage). |
