...
- **Whether Freebie Points can be spent on all four categories, or only some** — assumed all four ([source redacted]-style) but not explicitly confirmed.
- **Freebie Point conversion rate** — how many Freebies buy one rank of Attribute vs. Skill vs. Perk vs. Gift ([source redacted] itself uses a different rate per category, e.g. an Attribute dot costs more Freebies than a Skill dot).
