...
**Flaws grant Freebies on top of the 15 baseline**: non-Leveled Flaws grant **1-7 Freebies** ([source redacted]'s own severity range, GM/player negotiated per Flaw based on how much it actually constrains the character in play), and the 3 Leveled (Resource) Flaws grant **2 × the Flaw's level** (a level-3 Enemy grants 6 Freebies).
