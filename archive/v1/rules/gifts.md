...
- **Gifts require no in-fiction source or origin, confirmed 2026-07-15**: unlike a Perk (which grants its own standing without needing a prior justification either, by symmetry) or a WoD-style bloodline/pact/awakening, a Gift here doesn't need a bloodline, pact, training regimen, or mutation to explain it — a character simply has it. Consistent with the setting's own "the world is weird" framing: exceptional ability doesn't need a tidy origin story to be real.
