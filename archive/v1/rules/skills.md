...
**XP costs during Advancement, confirmed 2026-07-14**: raising an existing Skill costs `current rating × 2` (a direct import of [source redacted] cost — see [core-mechanic.md](core-mechanic.md) for the Attribute/Power Level/Gift equivalents). Learning a **brand-new Skill** (0→1) costs a **flat 3 XP**, reusing [source redacted]'s own "new Ability" override for the same reason [source redacted] needed one: the ×2 formula breaks down at a starting rating of 0.
